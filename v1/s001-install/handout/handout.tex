...
\\Zadání taky, ale pro úplnost: je na \url{http://pyladies.cz/} – sekce Materiály.

Seznam se se sousedkami a začni s instalací Pythonu; jakékoli otázky rádi
zodpoví pomocníci.
Až se sejdeme všechny, povíme si pár slov na úvod a naučíme se
základy práce s příkazovou řádkou. Pak instalaci dokončíme.
