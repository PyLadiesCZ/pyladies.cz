...
\startsection{Procvičení funkcí. Jestli jsi pythonní funkce nepsala už před kurzem, tak první z těchto projektů určitě udělej. Druhý jen pokud máš ráda geometrii :)}
...
\item Máš-li ráda geometrii*, můžeš zkusit dávat domečkové funkci dva argumenty:
    ...
    \\\emph{\small
        ...
        je potřeba ho převést na stupně (\texttt{from~math~import~degrees}).
    }
...
\\\verb+        ...+
    \\\emph{Můžeš využít nějakou funkci, kterou jsme napsali už na sraze?}
