...
\item \label{snakestart}
    ...
    napíše \texttt{X}, jinde tečku.
    Například:

\verb+nakresli_mapu([(0, 0), (1, 0), (2, 2), (4, 3), (8, 9), (8, 9)])+
\\\verb+X X . . . . . . . .+
\\\verb+. . . . . . . . . .+
\\\verb+. . X . . . . . . .+
\\\verb+. . . . X . . . . .+
...
\\\verb+print(souradnice)         # → [(0, 0), (1, 0)]+
\\\verb+pohyb(souradnice, 'v')+
\\\verb+print(souradnice)         # → [(0, 0), (1, 0), (2, 0)]+
\\\verb+pohyb(souradnice, 'j')+
\\\verb+print(souradnice)         # → [(0, 0), (1, 0), (2, 0), (2, 1)]+
\\\verb+pohyb(souradnice, 's')+
\\\verb+print(souradnice)         # → [(0, 0), (1, 0), (2, 0), (2, 1), (2, 0)]+
